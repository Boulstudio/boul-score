...
export async function POST(req: NextRequest) {
  ...
  const prompt = [
    ...
    "- confianza: Testimonios, casos de exito, portafolio y senales de credibilidad. CRITERIO: testimonios con foto, nombre y cargo son prueba social solida (85+). La ausencia de logo de empresa NO es penalizacion grave si hay foto y nombre. Casos de estudio con resultados medibles equivalen a testimonios formales. Contacto visible y SSL suman credibilidad. Penaliza fuerte solo si no hay ninguna prueba social, el sitio parece abandonado o no hay forma de contacto visible.",
