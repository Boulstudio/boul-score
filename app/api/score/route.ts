...
export async function POST(req: NextRequest) {
  ...
  const prompt = [
    ...
    "- confianza: Testimonios con foto y nombre, casos de exito y portafolio con resultados medibles, contacto visible. IMPORTANTE: un portafolio solido con casos de estudio cuenta como evidencia de confianza aunque no haya testimonios formales. Penaliza solo si no hay ninguna prueba social ni trabajo mostrado.",
